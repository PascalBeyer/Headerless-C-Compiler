...
char16_t *w_runes_check[] = {
   (char16_t []){0x16a0, 0x16c7, 0x16bb, 0x16eb, 0x16d2, 0x16e6, 0x16a6, 0x16eb, 0x16a0, 0x16b1, 0x16a9, 0x16a0, 0x16a2, 0x16b1, 0x16eb, 0x16a0, 0x16c1, 0x16b1, 0x16aa, 0x16eb, 0x16b7, 0x16d6, 0x16bb, 0x16b9, 0x16e6, 0x16da, 0x16b3, 0x16a2, 0x16d7, 0x0000},
   (char16_t []){0x16cb, 0x16b3, 0x16d6, 0x16aa, 0x16da, 0x16eb, 0x16a6, 0x16d6, 0x16aa, 0x16bb, 0x16eb, 0x16d7, 0x16aa, 0x16be, 0x16be, 0x16aa, 0x16eb, 0x16b7, 0x16d6, 0x16bb, 0x16b9, 0x16e6, 0x16da, 0x16b3, 0x16eb, 0x16d7, 0x16c1, 0x16b3, 0x16da, 0x16a2, 0x16be, 0x16eb, 0x16bb, 0x16e6, 0x16cf, 0x16eb, 0x16de, 0x16ab, 0x16da, 0x16aa, 0x16be, 0x0000},
   (char16_t []){0x16b7, 0x16c1, 0x16a0, 0x16eb, 0x16bb, 0x16d6, 0x16eb, 0x16b9, 0x16c1, 0x16da, 0x16d6, 0x16eb, 0x16a0, 0x16a9, 0x16b1, 0x16eb, 0x16de, 0x16b1, 0x16c1, 0x16bb, 0x16cf, 0x16be, 0x16d6, 0x16eb, 0x16de, 0x16a9, 0x16d7, 0x16d6, 0x16cb, 0x16eb, 0x16bb, 0x16da, 0x16c7, 0x16cf, 0x16aa, 0x16be, 0x16ec, 0x0000},
};
...
int main(){
	...
	for(int string_index = 0; string_index < sizeof(w_runes)/sizeof(*w_runes); string_index++){
		print("   (char16_t []){");
		for(char16_t *w_rune = w_runes[string_index]; *w_rune; w_rune++){
	...
	print("};\n");
		...
		for(int string_index = 0; string_index < sizeof(w_runes)/sizeof(*w_runes); string_index++){
			int length = 0;
                char16_t *str = w_runes[string_index];
        while(*str){
            length++;
            str++;
        }
			assert(memcmp(w_runes[string_index], w_runes_check[string_index], sizeof(char16_t) *(length + 1)) == 0);
		}
#endif	
	...
	for(int string_index = 0; string_index < 3; string_index++){
		...
		char16_t  *w_rune = w_runes[string_index];
		...
		for(char32_t *rune = u_rune; *rune; rune++){
			...
			if(codepoint < 0x10000){
				...
				char16_t w1 = w_rune[0];
				char16_t w2 = w_rune[1];
				w_rune += 2;
